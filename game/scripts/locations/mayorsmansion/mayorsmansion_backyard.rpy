...
label mayorsmansionbackyard_kitchen:
    if dogsleeping == False:
        if mayorsmansionbackyard.dogComment == True:
            ...
            "As [player_name] got closer to the mansion, he felt something bumping against his leg."
            show rocky happy with vpunch
            play music MUSIC_ROCKY_THEME
            "The dog which seemed to be sleeping, was looking at him and smelling his clothes."
            "After a couple of seconds, he stood in front of [player_name] and tilted his head."
            Jimmy "Hey, pal..."
            Jimmy "Ummm... You're a good, dog, right?"
            Jimmy "Please, don't bark."
            Jimmy "I'm a friend."
            "I tried to get closer, but the dog showed his teeth and growled."
            "I stepped back and the dog started licking his nose and savoring his mouth."
            Jimmy "Are you hungry, pal?"
            "The dog blinked and licked his nose, again."
            Jimmy "Alright, pal. I'll see what I can do."
            "Fuck, where the hell am I gonna get food for the dog?"
            "When [player_name] went back to the pool, the dog did the same thing, laying down on the same spot."
...
label mayorsmansionbackyard_wendyroom:
    if dogsleeping == False:
        if mayorsmansionbackyard.dogComment == True:
            ...
            show rocky happy with vpunch
            play music MUSIC_ROCKY_THEME
            "The dog that seemed to be sleeping, was looking at him and smelling his clothes."
            "After a couple of seconds, he stood in front of [player_name] and tilted his head."
            Jimmy "Hey, pal..."
            Jimmy "Ummm... you're a good, dog, right?"
            Jimmy "Please, don't bark."
...
label mayorsmansionbackyard_dog:
    if dogsleeping == True:
        ...
        $ dogsleeping = True
        "The dog jumped on the food spreading it everywhere."
        hide rocky happy with dissolve
        show rocky sleep aftereat with dissolve
        "With his stomach full, he stumbled a couple of steps away from the bag and went to sleep."
    else:
        if mayorsmansionbackyard.dogComment == True:
...
label mayorsmansionbackyard_backdoor:
    if dogsleeping == False:
        if mayorsmansionbackyard.dogComment == True:
            ...
            Jimmy "Please, don't bark."
            Jimmy "I'm a friend."
            " [player_name] tried to get closer, but the dog showed his teeth and growled."
            " [player_name] stepped back and the dog started licking his nose and savoring his mouth."
            Jimmy "Are you hungry, pal?"
            "The dog blinked and licked his nose, again."
            Jimmy "Alright, pal. I'll see what I can do."
            "Fuck, where the hell am I gonna get food for the dog?"

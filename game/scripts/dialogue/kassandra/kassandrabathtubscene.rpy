label kassandrabathtubscene:
    ...
    __("{i}The squeaking sound of a door opening took [player_name] by surprise.{/i}")
    __("{i}It came from the living room, was it possible that someone entered the house?{/i}")

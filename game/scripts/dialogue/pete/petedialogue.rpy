...
label .dialogmenu:
    menu:
        __("Ask about Derek") if quests.fionaConfrontDerek == ACTIVE:
            ...
            jump .dialogmenu
        __("Ask about the Halloween Plan") if quests.garyHalloweenHeist == ACTIVE:
            ...
            jump .dialogmenu
        __("Ask about the Halloween Plan") if quests.garyHalloweenHeist == SATISFIED:
            ...
            Jimmy "Alright, thanks Pete."
            jump .dialogmenu
        __("How can I go to Town during the weekend?") if not calendar.event == HALLOWEEN_EVENT:
...
label .dialogmenu:
    ...
    menu:
        __("Ask about the graffiti message") if quests.halloweenGraffitiMessage == ACTIVE:
            ...
            jump .dialogmenu
        __("Ask about the laxative plan") if quests.halloweenFruitPunch == ACTIVE:
            ...
            jump .dialogmenu
        __("Ask about the flag") if quests.halloweenFakeFlag == ACTIVE:

...
label blairdrunkscene:
    ...
    "It was Blair throwing rocks at his window, she was holding a bottle of liquor in her hand and wearing very short clothes which wasn't usual for her."
    Jimmy "What the hell, Blair? It's 2 am..."
    "[player_name] whispered. Blair was making signs for him to come down and meet her outside."
    "[player_name] replied with another sign for her to wait for him."
    ...
    "[player_name] could smell the alcohol in her breath, she was very drunk but was able to talk very clearly."
    ...
    Blair "I'm sorry too."
    "Blair was struggling to stand on her feet, so [player_name] had an idea."
    Jimmy "You can't even walk in this state."
    Jimmy "Hop on my back. I'll take you to your room quietly."
    "A pretty smile formed in Blair's face, who's clear skin was even more bright with the moonlight."
    Blair "Alright, [player_name]."
    scene blairtransport01 with fade
    "The house was very quiet. [player_name] already had some experience sneaking in places, so the way to Blair's room was easy enough."
    scene blairtransport02 with fade
    "Upon reaching her bedroom, [player_name] was starting to struggle with her weight."
    scene blairtransport03 with fade
    "But being so close to her bed, he put her down and she woke up from her short slumber."

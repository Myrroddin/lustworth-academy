...
label halloween_cassidyjacuzzi:
    ...
    if quests.halloweenGraffitiMessage == ACTIVE:
        "After having fun in the jacuzzi, [player_name]'s head was clearer than ever."
        "He realized the jacuzzi had to be one of the preps' favorite places to hang out."
        "So, it was the perfect place to leave a message."
        play sound "audio/sfx/guitarriff01.ogg"

...
label prologue_mayorspeech:
    ...
    "An imposing man walked up to the podium with an expression of absolute seriousness."
    "Everyone in the room went silent, waiting for him to start his speech."
    "Instead, he just stood there, looking at every single person in the crowd with an intimidating stare."
    "When he reached [player_name], he paused."
    " [player_name] didn't flinch for a moment."
    ...
    "Murmurs of expectation and uncertainty filled the room."
    ...
    "It's her..."
    "She's the one!"
    "When the applause and cheers ended, everyone started to slowly leave the auditorium."
    "The mayor went to talk to the Headmaster while his daughter went backstage."
    scene auditoriumhallfallevening with fade
    show jimmy neutral
...
label prologue_wendybackstage:
    ...
    "Being careful not to be seen by the monitors, [player_name] snuck backstage looking for Wendy."
    show wendy doubt with dissolve
    "He finally saw her behind some curtains. Being up close, he saw her green eyes and the orange hair, she was the one for sure."
    ...
    "Wendy's face blushed for a moment, and her voice started to tremble."
    ...
    "Wendy looked at [player_name] in the eyes and raised an eyebrow. [player_name] felt that this time he was in real trouble."
    ...
    "A mischevious smile showed on Wendy's face as she went out."
...
label prologue_kassandraintro:
    ...
    "A tall, voluptuous woman with braided hair got out of a blue mini convertible."
    show kassandra neutral with dissolve
    "This woman was beautiful, and when [player_name] saw her, he felt as if he had known her his whole life."
    ...
    "An uncomfortable silence along with dismayed stares was the first formal interaction they had."
    hide blair
    hide cassidy
    with dissolve
    Alice "Hi, I'm Alice."
    ...
    "Cassidy blushed almost immediately."
    ...
    "The buildings and houses around town were pretty colorful."
    "A lot of vegetation covered the valley to the coastline."
    "Far away, you could see the mountains to the northeast..."
    "Followed by lush hills where fancier houses and mansions stood."
    "For a moment, [player_name] thought that his new house was among the richest part in town."
    "The sight of a huge mansion near a cliff called his attention."
    ...
    "The house seemed to be in a residential area not far away from the coastline."
    "As the car rounded a corner, [player_name] caught a glimpse of a large carnival on a pier."
    "Even further away, he had a sight of what seemed to be a small industrial area."
    scene housefrontfallnight with fade
    "Minutes later, they finally arrived home."
    "It was a modest house, but a lot bigger than [player_name] expected."
...
label prologue_day3start:
    ...
    "When the sun came out that morning, [player_name] woke up early to start the development of his plan."
...
label prologue_mayorsmansion:
    ...
    "With one goal in mind, [player_name] crept out of the window and started walking towards the beach."
    "It was exciting. He was going to fulfill his promise to Wendy and let her know that he meant serious business."
    "Of course, he was thinking with his penis, not even considering the real consequences his actions might bring."
    "Everything worked just like he planned, and soon he found himself in the backyard of the huge mansion."
...
label prologue_wendyinfiltration:
    hide screen freeroamhud
    "After climbing the trellis with cat-like grace, [player_name]'s fingers grazed the cold ledge as he pulled himself up."
    scene wendyroomnightintro with fade
    "Wendy's room was on the top floor. A symphony of opulence with velvet drapes, gilded mirrors, and a bed that could fit a dozen people."
    stop music
    scene wendywalkmandancing with dissolve
    play music "audio/sfx/wendyheadphones.ogg"
    "There she was in the middle of the room, holding a walkman with headphones covering her ears."
    "Her eyes were closed, and her lips moved silently, mouthing the lyrics."
    "[player_name] watched as she danced, her movements fluid and not selfconscious."
    "He admired her butt moving slowly with grace, remembering the last night the danced together in his bed."
    "Then, as if sensing his presence, she opened her eyes."
    stop music
    play sound "audio/sfx/scream01.ogg"
    scene wendywalkmansurprise with vpunch
    Wendy "AAAHHHH!"
    "The walkman slipped from her fingers as she put the headphones away. She hurried to the window, her eyes wide."
    scene wendyroomnightintro with fade
    show jimmy smug with dissolve
    ...
    "Wendy couldn't hold a laugh as she made sure her door was closed."
...
label prologue_jimmycaught:
    ...
    "Without saying a word, [player_name] did as the Mayor asked."
...
label prologue_policestation:
    ...
    "The sexy officer left without answering [player_name]'s question."
    Jimmy "Well, shit."
    ...
    "The hobo approached the lock and, making a weird sound with his throat, spat over it."
    "More disgusted than he'd ever been, [player_name] watched the green slime slide into the lock... and suddenly heard a click."
    Grant "Here we go."
    scene policestationcellblockgrantopen with vpunch
    play sound "audio/sfx/metalgateopen.ogg"
    "The gate opened, also leaving [player_name] more confused than he'd ever been."

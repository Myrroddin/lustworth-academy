...
label prologue_blairusbcollision:
    ...
    "As Blair was coming down the stairs, you bumped into her."
    "Your USB stick fell to the floor, along with hers."
    ...
    show jimmy neutral with dissolve
    "Blair took the USB stick on the right and ran back to her room."
...
label prologue_blairlesbianvideo:
    ...
    "As Blair entered the room, sweating and nervous, she looked at Cassidy, then at [player_name], then finally at the screen."
    "When she saw the video playing, her whole body froze."
    ...
    " [player_name] quickly stopped the video and pulled the USB out of his computer."
    ...
    "An uncomfortable silence filled the room as Cassidy and Blair shot daggers at each other."
...
label prologue_awkwardbreakfast:
    ...
    "The first day in his new house, [player_name] realized how good his [landlady_name]'s food was."
    "Everything on the table looked, smelled, and tasted delicious."
    scene awkwardbreakfast02 with dissolve
    "However, Cassidy and Blair were really quiet."
    ...
    Cassidy "Nothing, Mom."
    "The tension between Blair, Cassidy, and [player_name] was growing as time passed."
    "[player_name] tried to finish his food as fast as he could."
    scene breakfasttime01 with fade
    ...
    "As he got up from the table, the girls left the room in a rush."

...
label prologue_mysterygirlnight1:
    ...
    "It was uncertain if the girl left because she discovered his true identity..."
    "or because someone else was watching through the window.{/i}"
    "Still, she left a very good impression on [player_name], and now he wanted to know who she was.{/i}"
...
label prologue_spanishclassintro:
    ...
    "\"Holy shit\" thought [player_name], realizing how hot the teacher was."
...
label prologue_cassidyintro:
    ...
    stop music
    play sound SOUND_RECORD_SCRATCH
    "As I turned to leave, I heard her moan again."
    play sound "audio/sfx/gasp02.ogg"
    "This time though, it wasn't out of pleasure."
...
label prologue_mysterygirlnight2:
    ...
    "Once more, [player_name] realized that there was figure in the window."
    "Someone was watching."
    Jimmy "Hey! Who's there!?"
    Jimmy "Stay right there!"
    scene misterygirlshadow02 with dissolve
    "The figure once more dissapeared in the blackness of the night."
    Jimmy "What the fuck?"
    scene nightsky with fade
    "He took a long breath one more time before falling sleep."
    "Not before he cleaned himself, of course. He's a very hygienic guy."
    ...
    "Peacock town seemed like a quiet and idillic place at night."
    "A place where the sky merged with the sea in the distance..."
    show oldsage neutral shadow with dissolve
    "However, there were secrets lurking in the shadows, mysterious figures with unknown intentions."
    "And while the stars painted the dreams in which [player_name] was profoundly immersed..."
    "He didn't even know he was part of a greater plan."

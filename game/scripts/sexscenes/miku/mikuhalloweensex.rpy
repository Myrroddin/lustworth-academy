label miku_halloweensex_scene:
    play music MUSIC_SEXY_THEME
    scene mikuwizard69intro with fade
    Miku "Now, come here and use that muscle you have in your mouth."
    Jimmy "Fuck, you really are flexible."
    Miku "And you really are hard."
    ...
    Jimmy "Oh, yes, baby."
    Miku "FUCK, FUCK, FUCK!"
    Miku "How can you lift me up like this?"
    Jimmy "You're not that heavy!"
    Miku "Fuck, this is so hot!"
    Miku "AH!"
    Miku "AH!"
    Miku "YES YES!"
    Miku "AH AAAH!"
    Miku "AAAAHHH!"
    Miku "I feel it so up inside me!"
    Miku "Stretching my out so good!"
    Miku "I'm gonna cum!"
    Jimmy "I'm cumming too!"
    Miku "OOOOOHH GOOOOD!!"
    ...
    Jimmy "I'll let you rest."
    Jimmy "See you in class..."
    stop music
    if mikugallery == True:
...
image mikuwizardstandfuckanim:
    "mikuwizardstandfuckanim01"
    pause 0.12
    "mikuwizardstandfuckanim02"
    pause 0.1
    "mikuwizardstandfuckanim03"
    pause 0.07
    "mikuwizardstandfuckanim04"
    pause 0.07
    "mikuwizardstandfuckanim05"
    pause 0.1
    "mikuwizardstandfuckanim06"
    pause 0.07
    "mikuwizardstandfuckanim07"
    pause 0.07
    "mikuwizardstandfuckanim08"
    pause 0.1
    repeat

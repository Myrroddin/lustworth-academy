label fiona_dadrevenge_scene:
    ...
    Fiona "You are going to fuck me right here in my father's office."
    play sound "audio/sfx/mh1.ogg"
    Fiona "And this will be the best memory I will have of this damn place."
    Fiona "He's going to wish he never took my permit."
    Jimmy "Fiona, are you sure about this?"
    Fiona "YES! Don't worry! He won't know you were here with me."
    Fiona "Sit on the couch."
    Fiona "I'm gonna sit on that cock so hard that the couch will break."
...
label .slow:
    ...
    scene fionadadrevengeanimslow with fade
    Fiona "Ahhh, fuuuuuck!"
    Fiona "Yes, I love that you're taking control!"
...
label .fast:
    ...
    scene fionadadrevengeanimfast with vpunch
    Fiona "Ohhh, that feels so good!"
...
label .cum:
    ...
    Fiona "I'm so full of cum, daddy!"
    return

image fionadadrevengeanimslow:
    "fionadadrevengeanim01"
    pause 0.08
    "fionadadrevengeanim02"
    pause 0.08
    "fionadadrevengeanim03"
    pause 0.08
    "fionadadrevengeanim04"
    pause 0.08
    "fionadadrevengeanim05"
    pause 0.08
    "fionadadrevengeanim06"
    pause 0.08
    "fionadadrevengeanim07"
    pause 0.08
    "fionadadrevengeanim08"
    pause 0.08
    "fionadadrevengeanim09"
    pause 0.08
    "fionadadrevengeanim10"
    pause 0.08
    "fionadadrevengeanim11"
    pause 0.08
    "fionadadrevengeanim12"
    pause 0.08
    repeat

image fionadadrevengeanimfast:
    "fionadadrevengeanim01"
    pause 0.05
    "fionadadrevengeanim02"
    pause 0.05
